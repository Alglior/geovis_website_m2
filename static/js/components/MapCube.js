// Map MacEachren Cube Component - 3D Three.js version
// Displays the specific characteristics of an individual map
const MapCube = ({ config }) => {
    ...
    React.useEffect(() => {
        ...
        // Beam from origin toward the point
    ...
    return React.createElement('div', { className: 'map-cube-card' }, [
        React.createElement('div', { className: 'map-cube-title', key: 'title' }, [
            React.createElement('span', { className: 'cube-label', key: 'label' }, 'CARTOGRAPHY'),
            React.createElement('sup', { key: 'sup' }, '3')
        ]),
        React.createElement('div', { className: 'map-cube-content', key: 'content' }, [
            React.createElement('div', { className: 'map-cube-canvas', ref: containerRef, key: 'canvas' }),
            React.createElement('div', { className: 'map-cube-legend', key: 'legend' }, [
                ...
                React.createElement('ul', { key: 'axes-list' }, [
                    ...
                    React.createElement('li', { key: 'y' }, [
                        ...
                        React.createElement('span', { key: 'texty' }, 'Communication / Audience (privé → public)')
                    ]),
                    React.createElement('li', { key: 'z' }, [
                        React.createElement('span', { className: 'legend-dot purple-dark', key: 'dotz' }),
                        React.createElement('span', { key: 'textz' }, 'Tâche (révéler l\'inconnu → présenter le connu)')
                    ])
                ]),
                React.createElement('h4', { key: 'values-title' }, 'Valeurs'),
                React.createElement('div', { className: 'map-cube-values', key: 'values' }, [
                    ...
                    React.createElement('div', { className: 'cube-value', key: 'val-task' }, [
                        React.createElement('span', { className: 'value-label', key: 'l2' }, 'Tâche'),
                ...
                React.createElement('p', { className: 'map-cube-hint', key: 'hint' }, 
                    'Astuce : cliquez-glissez pour tourner le cube'
                )
            ])
        ])
    ]);
